      ...
      <li class="nav-item">
       ...
       <li class="nav-item dropdown">
        <a class="nav-link " data-toggle="dropdown" href="#">
            <div class="user-panel justify-center p-1 d-flex">
                @auth
                    ...
                    @else
                    <div class="image">
                        <img src="{{ asset('img/avatar.png') }}"  class="h-10 w-10 rounded-full" alt="User Image">
                    </div>
                    @endif
                @else
                <div class="image">
    ...
    @endauth
      ...
      <nav class="mt-2">
          ...
          @if (Auth::user()->role == 'admin')
           ...
           <li class="nav-item menu-open mb-3">
            <a href="{{ route('admins') }}" class="nav-link {{ Request::is('dashboard/admins') ? 'active' : ''}}">
              <i class="nav-icon gap-3 fas fa-user-lock"></i>
              <p>
                Admins
              </p>
            </a>
        ...
        @if (Auth::user()->role == 'admin')
          {{-- Skills --}}
          <li class="nav-item menu-open mb-3">
              <a href="{{ route('skills') }}" class="nav-link {{ Request::is('dashboard/skills') ? 'active' : ''}}">
        ...
        @endif
          ...
          <li class="nav-item menu-open mb-3">
            <a href="{{ route('quezes') }}" class="nav-link {{ Request::is('dashboard/quezes') ? 'active' : ''}}">
