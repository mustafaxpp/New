<div class="">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Skills Table</h6>
        </div>
                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @forelse (App\Models\Skill::all() as $skill )
                         ...
                         <tr>
                             <td class="text-danger">{{$skill->id}}</td>
                             ...
                             <td><a class="btn btn-sm btn-success" title="Edit {{$skill->name}}" wire:click='edit({{$skill->id}})'> Edit </a> </td>
                             <td><a class="btn btn-sm btn-danger" title="Delete {{$skill->name}}"  data-toggle="modal" data-target="#exampleModal{{$skill->id}}"> X </a> </td>
                         </tr>
                         <!-- Modal -->
                         <div class="modal fade" id="exampleModal{{$skill->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                             ...
                             <div class="modal-content">
                                 ...
                                 <button type="button" class="btn btn-danger" data-dismiss="modal" wire:click='delete({{$skill->id}})'>Delete</button>
                                 </div>
                             </div>
                             </div>
                         </div>
